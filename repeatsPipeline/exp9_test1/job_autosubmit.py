...
os.system('echo "pass" > /share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/logs/exp9_test1/test2.txt')
...
os.system('echo ' + str(slots) + ' >> /share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/logs/exp9_test1/test3.txt')
    ...
    for infile in in_files:
        ...
        for i in range(total_no_jobs):
            ...
            if not all([os.path.isfile(inp) for inp in inputs]):
                ...
                os.system('echo At least one job ' + str(i) + ' input file does not exist, holding job >> /share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/logs/exp9_test1/test4.txt')
                ...
                os.system('echo /opt/gridengine/bin/linux-x64/qsub ' \
                      ...
                      + ' '.join(inputs) + ' ' \
                      + ' '.join(outputs) + ' ' \
                      + extra_params[i] + '>> /share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/logs/exp9_test1/test4.txt'
                    )
                ...
                os.system(' echo Job ' + str(i) + ' has previously been completed, no need to run >> /share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/logs/exp9_test1/test4.txt')

            elif 'j' + str(i) + '_' + u_id in qstat_jobs:
                os.system('echo Job ' + str(i) + ' is currently running or queued, no need to run again >> /share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/logs/exp9_test1/test4.txt')
