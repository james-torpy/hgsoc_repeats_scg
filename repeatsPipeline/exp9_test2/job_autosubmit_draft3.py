...
# */10 * * * * /home/jamtor/local/bin/Python-3.6.3/bin/python3.6 /share/ClusterShare/thingamajigs/jamtor/projects/hgsoc_repeats/RNA-seq/scripts/repeatsPipeline/exp9_test2/job_autosubmit.py
...
# delete qsubs script:
if os.path.isfile(script_dir + '/qsubs.bash'):
    os.remove(script_dir + '/qsubs.bash')

# set up new qsubs script:
qrec = open(script_dir + '/qsubs.bash', 'w')
...
#                qrec = open(script_dir + '/qsubs.bash', 'a')
...
#                      + '\n'
#                    )
#                os.system('chmod 755 ' + script_dir + '/qsubs.bash')
