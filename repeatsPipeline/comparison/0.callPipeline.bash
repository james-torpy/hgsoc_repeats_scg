...
directories=( $(ls $bamDir | grep -v sorted) )
...
for inDir in ${directories[@]}; do
	...
	annot="custom3"
	# 5a.countOverlaps_c1.R:
	qsub -q short.q -N fCtest -b y -wd "/share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/scripts/logs" -j y -R y -P GenomeInformatics -pe smp 12 -V "/home/jamtor/local/lib/r/R-3.2.2/bin/R --vanilla < /share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/scripts/repeatsPipeline/exp3/5a.countOverlaps_c1.R"
	# 5b.countOverlaps_c2.R:
