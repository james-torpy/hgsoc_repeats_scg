...
if (file.exists(paste0(RobjectDir, "/", annot, "_RepeatGenes_strandless1.rds"))){
	Genes <- readRDS(file = paste0(RobjectDir, "/", annot, "_RepeatGenes_strandless1.rds"))
} else {
	...
	saveRDS(Genes, file = paste0(RobjectDir, "/", annot, "_RepeatGenes_strandless1.rds"))
}

if (file.exists(paste0(RobjectDir, "/", annot, "_RepeatGenes_strandlessSAF1.rds"))) {
	SAF <- readRDS(file=paste0(RobjectDir, "/", annot, "_RepeatGenes_strandlessSAF1.rds"))
} else {
...
saveRDS(SAF, file = paste0(RobjectDir, "/", annot, "_RepeatGenes_strandlessSAF1.rds"))
}
...
saveRDS(allResults, file=paste0(RobjectDir, "/", uID, "_allFeatureResults1.rds"))
...
saveRDS(allCounts, file=paste0(RobjectDir, "/", uID, "_allFeatureCounts1.rds"))
