...
if (file.exists(paste0(outDir, "/", uID, "_", annot, "RepeatCountsExt_half2.rds already exists, no need to create"))) {
  print(paste0(outDir, "/", uID, "_", annot, "RepeatCountsExt_half2.rds"))
} else {
  print(paste0("Creating ", outDir, "/", uID, "_", annot, "RepeatCountsExt_half2.rds"))
  saveRDS(Counts, file = paste0(outDir, "/", uID, "_", annot, "RepeatCountsExt_half2.rds"))
}
...
if (file.exists(paste0(outDir, "/", uID, "_", annot, "RepeatCounts_half2.rds already exists, no need to create"))) {
  ...
  saveRDS(tCounts, file = paste0(outDir, "/", uID, "_", annot, "RepeatCounts_half2.rds"))
}
