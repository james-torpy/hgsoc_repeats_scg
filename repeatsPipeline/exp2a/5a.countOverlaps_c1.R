...
if (file.exists(paste0(outDir, "/", uID, "_", annot, "RepeatCountsExt_half1a.rds already exists, no need to create"))) {
  print(paste0(outDir, "/", uID, "_", annot, "RepeatCountsExt_half1a.rds"))
} else {
  print(paste0("Creating ", outDir, "/", uID, "_", annot, "RepeatCountsExt_half1a.rds"))
  saveRDS(Counts, file = paste0(outDir, "/", uID, "_", annot, "RepeatCountsExt_half1a.rds"))
}

if (file.exists(paste0(outDir, "/", uID, "_", annot, "RepeatCounts_half1a.rds already exists, no need to create"))) {
  print(paste0(outDir, "/", uID, "_", annot, "RepeatCounts_half1a.rds"))
} else {
  print(paste0("Creating ", outDir, "/", uID, "_", annot, "RepeatCounts_half1a.rds"))
  saveRDS(tCounts, file = paste0(outDir, "/", uID, "_", annot, "RepeatCounts_half1a.rds"))
}
