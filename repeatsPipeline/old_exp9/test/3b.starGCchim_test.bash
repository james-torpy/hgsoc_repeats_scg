...
uID="rcAF16"
numcores=6
fastqPath="/share/ScratchGeneral/jamtor/projects/hgsoc_repeats/RNA-seq/raw_files/fullsamples/bowtell_primary/fastq"
...
scriptsPath="/share/ClusterShare/thingamajigs/jamtor/projects/hgsoc_repeats/RNA-seq/scripts/repeatsPipeline/exp9"

# set in/outPaths:
fastqPath="$rawDir/fullsamples/bowtell_primary/fastq/"

genomeName="hg38_ercc"
genomeDir="/home/jamtor/genomes/$genomeName/starRef/"
...
#/opt/gridengine/bin/linux-x64/qsub -q short.q -N $uID_prPT11 -b y -wd /share/ClusterShare/thingamajigs/jamtor/projects/hgsoc_repeats/RNA-seq/logs/exp9 -j y -R y -pe smp 6 -V $starline

/opt/gridengine/bin/linux-x64/qsub -q long.q -N j3b_$uID -hold_jid fq_$uID -b y -wd \
/share/ClusterShare/thingamajigs/jamtor/projects/hgsoc_repeats/RNA-seq/logs/exp9 -j y -R y -P \
DSGClinicalGenomics -pe smp $numcores -V $starline
