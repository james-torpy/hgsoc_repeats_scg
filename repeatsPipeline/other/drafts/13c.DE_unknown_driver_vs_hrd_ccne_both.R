...
plotDir <- paste0(resultsDir, "/R/", expName,
                  "/plots/DEplots/unknown_vs_hrd_ccne_/")
...
# determine which column is unknown_driver:
Uind <- grep("unknownDrivers", colnames(design))
con <- c(rep(0, (Uind - 1) ), -1, rep(0, (ncol(design) - Uind)))
