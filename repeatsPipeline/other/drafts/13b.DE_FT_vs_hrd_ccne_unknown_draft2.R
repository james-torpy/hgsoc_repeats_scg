...
loadingRobjectDir <- paste0(projectDir, "/RNA-seq/Robjects/", expName)
...
custom3Counts <- readRDS(paste0(loadingRobjectDir, "/", Type,
  "_allcounts.htseq.rds"))
gcCounts <- readRDS(paste0(loadingRobjectDir,
