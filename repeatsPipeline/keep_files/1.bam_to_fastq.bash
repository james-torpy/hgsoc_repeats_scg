...
files=( $(ls $inPath/*.bam | grep -v sorted | grep prPT8.bam) )
...
#	qsub -q $subType.q -N fastq_$uID -b y -wd $logDir -j y -R y -P GenomeInformatics \
...
#	$scriptsPath/repeatsPipeline/keep_files/2.fastq_report_gen.bash $uID $outPath $projectDir \
#	$inFile
	# 3a.starRibo.bash:
#	qsub -q $subType.q -N sc3a_$uID -hold_jid sc2_$uID -b y -wd $logDir -j y -R y -P \
#	GenomeInformatics -pe smp $largecores \
#	$scriptsPath/repeatsPipeline/keep_files/3a.starRibo.bash $uID $outPath $projectDir \
#	$largecores
	# 3b.starGC.bash:
#	qsub -q $subType.q -N sc3b_$uID -hold_jid sc2_$uID -b y -wd $logDir -j y -R y -P \
#	GenomeInformatics -pe smp $largecores \
#	$scriptsPath/repeatsPipeline/keep_files/3b.starGC.bash $uID $outPath $projectDir $largecores
#	# 4.bam_report_gen.bash:
#	qsub -q $subType.q -N sc4_$uID -hold_jid sc3a_$uID,sc3b_$uID -b y -wd $logDir -j y -R y -P \
#	GenomeInformatics -pe smp $smallcores \
#	$scriptsPath/repeatsPipeline/keep_files/4.bam_report_gen.bash $uID $outPath
#	
#	annot="c"
#	# 5a.countOverlaps_c1.R:
#	qsub -q $subType.q -N isc5a_$uID -hold_jid sc4_$uID -b y -wd $logDir -j y -R y -P \
#	GenomeInformatics -pe smp $largecores -V "$RDir --vanilla --args $inFile $uID \
#	$projectDir $annot < $scriptsPath/repeatsPipeline/keep_files/5a.countOverlaps_c1.R"
#	# getLibSize.R:
##	qsub -q $subType.q -N isc5a_$uID -b y -wd $logDir -j y -R y -P \
##	GenomeInformatics -pe smp $largecores -V "$RDir --vanilla --args $inFile $uID \
##	$projectDir < $scriptsPath/repeatsPipeline/keep_files/getLibSize.R"
#	# 5b.countOverlaps_c2.R:
#	qsub -q $subType.q -N isc5b_$uID -hold_jid sc4_$uID -b y -wd $logDir -j y -R y -P \
#	GenomeInformatics -pe smp $largecores -V "$RDir --vanilla --args $inFile $uID \
#	$projectDir $annot < $scriptsPath/repeatsPipeline/keep_files/5b.countOverlaps_c2.R"
#	
#	annot="custom3"
#	# 5a.countOverlaps_c1.R:
...
#	GenomeInformatics -pe smp $largecores -V "$RDir --vanilla --args $uID $projectDir \
#	< $scriptsPath/repeatsPipeline/keep_files/6.compGen.R"
