...
other_df <- read.table(paste0(refDir, "/liu2018_top_repressors.txt"), header=T)
...
#            "dodgerblue1", "firebrick1"))
          ...
          otherGenes$type_thresh <- factor(otherGenes$type_thresh, levels = c("ctl_NEGATIVE",
            "ctl_POSSIG", "0.1_TRUE", "0.1_FALSE", "0.3_TRUE", "0.3_FALSE"))
