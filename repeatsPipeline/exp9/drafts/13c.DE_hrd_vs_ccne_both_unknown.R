...
allReps <- append(allReps[1:2], allReps[4])
names(allReps) <- c(paste0("HRD_vs_", sTypes[1:2]), paste0("HRD_vs_", sTypes[4]))

sigReps <- append(sigReps[1:2], sigReps[4])
names(sigReps) <- c(paste0("HRD_vs_", sTypes[1:2]), paste0("HRD_vs_", sTypes[4]))
...
#allSig <- append(allSig[1:2], allSig[4])
#names(allSig) <- c(paste0("HRD_vs_", sTypes[1:2]), paste0("HRD_vs_", sTypes[4]))
