...
RobjectDir <- paste0(projectDir, "/RNA-seq/Robjects/",
                        expName, "/hrd_vs_ccne_unknown/")
plotDir <- paste0(resultsDir, "/R/", expName,
                  "/plots/DEplots/hrd_vs_ccne_unknown_ccne_vs_unknown/")
...
# append repeat species of HRD vs others and CCNE vs others DE repeat list:
other_sigReps <- readRDS(file = paste0(projectDir, "/RNA-seq/Robjects/",
                         expName, "/hrd_vs_ccne_unknown_and_ccne_vs_hrd_unknown/", Type, "_DEsigReps.rds"))
sigRepNames <- unique(append(sigRepNames, rownames(other_sigReps[[1]])))
...
pheatmap(logCPMR, fontsize = 7, cluster_cols = F, color = colorRampPalette(c("white", "firebrick"))(50))
