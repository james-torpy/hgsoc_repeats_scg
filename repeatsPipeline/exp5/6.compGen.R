...
#projectDir <- "/share/ClusterShare/thingamajigs/jamtor/projects/hgsoc_repeats/RNA-seq/"
...
inFile <- paste0(projectDir, "/results/star/GC/", uID, "/Aligned.sortedByName.out.bam")
...
if (file.exists(paste0(RobjectDir, uID, "_bamGR.rds"))) {
  ...
  # sort or index bam if needed:
  if (file.exists(paste0(bamDir, "/Aligned.sortedByCoord.out.bam.bai"))) {
    print(paste0("No need to index, ", bamDir, "/Aligned.sortedByCoord.out.bam.bai
     has already been indexed"))
  } else {
    if (file.exists(paste0(bamDir, "/Aligned.sortedByCoord.out.bam"))) {
      print(paste0("Indexing ", bamDir, "/Aligned.sortedByCoord.out.bam"))
      indexBam(paste0(bamDir, "/Aligned.sortedByCoord.out.bam"))
    } else {
      print(paste0("Sorting ", inFile, " by co-ordinate"))
      sortBam(inFile, paste0(projectDir, "/results/star/GC/", uID, "/Aligned.sortedByCoord.out"))
      print(paste0("Indexing ", bamDir, "/Aligned.sortedByCoord.out.bam"))
      indexBam(paste0(bamDir, "/Aligned.sortedByCoord.out.bam"))
    }
  }
