...
if (file.exists(paste0(outDir, "/", uID, "_", annot, "RepeatCountsExt_half1b.rds"))) {
  print(paste0(outDir, "/", uID, "_", annot, "RepeatCountsExt_half1b.rds already exists, no need to create"))
} else {
  print(paste0("Creating ", outDir, "/", uID, "_", annot, "RepeatCountsExt_half1b.rds"))
  saveRDS(Counts, file = paste0(outDir, "/", uID, "_", annot, "RepeatCountsExt_half1b.rds"))
}

if (file.exists(paste0(outDir, "/", uID, "_", annot, "RepeatCounts_half1b.rds"))) {
  print(paste0(outDir, "/", uID, "_", annot, "RepeatCounts_half1b.rds already exists, no need to create"))
} else {
  print(paste0("Creating ", outDir, "/", uID, "_", annot, "RepeatCounts_half1b.rds"))
  saveRDS(tCounts, file = paste0(outDir, "/", uID, "_", annot, "RepeatCounts_half1b.rds"))
}
...
if (!file.exists(paste0(outDir, "/", uID, "_GCcountsDFb.rds"))) {
  ...
  saveRDS(GCcountsDF, file = paste0(outDir, "/", uID, "_GCcountsDFb.rds"))
}

if (!file.exists(paste0(outDir, "/", uID, "_GCcountsDFext_b.rds"))) {
  GCcountsDFext <- as.data.frame(countOverlaps(GCgenes, bamGR))
  saveRDS(GCcountsDFext, file = paste0(outDir, "/", uID, "_GCcountsDFext_b.rds"))
}
...
if (!file.exists(paste0(outDir, "/", uID, "_rGCcountsDFb.rds"))) {
  rGCcountsDF <- as.data.frame(countOverlaps(rGCgenes, bamGR))
  saveRDS(rGCcountsDF, file = paste0(outDir, "/", uID, "_rGCcountsDFb.rds"))
}

if (!file.exists(paste0(outDir, "/", uID, "_rGCcountsDFext_b.rds"))) {
  rGCcountsDFext <- as.data.frame(countOverlaps(rGCgenes, bamGR))
  saveRDS(rGCcountsDFext, file = paste0(outDir, "/", uID, "_rGCcountsDFext_b.rds"))
}