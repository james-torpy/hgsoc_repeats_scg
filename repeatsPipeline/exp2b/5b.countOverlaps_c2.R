...
bamDir <- paste0(projectDir, "/results/star/GC/exp2/", uID, "/")
...
if (file.exists(paste0(outDir, "/", uID, "_", annot, "RepeatCounts_half2b.rds"))) {
  print(paste0(outDir, "/", uID, "_", annot, "RepeatCounts_half2b.rds already exists, no need to create"))
} else {
  print(paste0("Creating", outDir, "/", uID, "_", annot, "RepeatCounts_half2b.rds"))
  saveRDS(Counts, file = paste0(outDir, "/", uID, "_", annot, "RepeatCounts_half2b.rds"))
}
